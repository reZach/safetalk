...
// to generate: https://www.asp.net/signalr/overview/guide-to-the-api/hubs-api-guide-javascript-client#manualproxy
...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['chatHub'].server = {
            online: function () {
                /// <summary>Calls the Online method on the server-side ChatHub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['chatHub'].invoke.apply(proxies['chatHub'], $.merge(["Online"], $.makeArray(arguments)));
            },

            send: function (name, message, cookie) {
                ...
                /// <param name=\"cookie\" type=\"String\">Server side type is System.String</param>
